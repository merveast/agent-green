#!/usr/bin/env python3
"""
Run Non Agentic Log parsing experiment.
"""
import os
import time
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Run Log Parsing experiment")
    ...
    TASK = "log-parsing"
    shot = args.shot
    # Set DESIGN depending on shot. If user provided an NA- prefixed design, prefer it.
